...
top_keyword_query = queries['top_keyword_query']['sql']
...
df_display = df_sorted[['FILM_TITLE', 'FILM_YEAR', 'SCORE_WEIGHTED', 'STREAMING_SERVICES', 'FILM_WATCH_COUNT', 'FILM_RATING', 'MIN_RENTAL_PRICE']]
...
with tab1:
    ...
    st.dataframe(df_weighted.head(films_to_show)[['FILM_TITLE_SORT', 'TOTAL_WEIGHTED_SCORE'] + y_cols])
