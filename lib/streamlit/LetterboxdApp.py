...
with year_tab:
    ...
    st.bar_chart(data=st.session_state['dfs']['year_completion'], x='FILM_YEAR', y='MY_RATING_MEAN', use_container_width=True)
    st.bar_chart(data=st.session_state['dfs']['year_completion'], x='FILM_YEAR', y='LETTERBOXD_RATING_MEAN', use_container_width=True)
    st.bar_chart(data=st.session_state['dfs']['year_completion'], x='FILM_YEAR', y='LETTERBOXD_WATCH_COUNT', use_container_width=True)
    st.bar_chart(data=st.session_state['dfs']['year_completion'], x='FILM_YEAR', y='LETTERBOXD_WATCHES_PER_FILM', use_container_width=True)
    st.bar_chart(data=st.session_state['dfs']['year_completion'], x='FILM_YEAR', y='LETTERBOXD_WATCH_COUNT_WATCHED', use_container_width=True)
    st.bar_chart(data=st.session_state['dfs']['year_completion'], x='FILM_YEAR', y='LETTERBOXD_WATCH_COUNT_WATCHED_PERCENT', use_container_width=True)
    st.line_chart(data=st.session_state['dfs']['year_completion'], x='FILM_YEAR', y=['LETTERBOXD_RATING_MEAN', 'MY_RATING_MEAN'], use_container_width=True)
